...
class ClassOptionsButton extends React.Component {
    ...
    render() {
        ...
        if (
            ...
            return (
                <button
                    ...
                    value={this.props.classOption} key={this.props.classOption} onClick={this.props.classFunction} disabled>
        ...
        return (
            ...
            <button
                className="button button-class-option"
                value={this.props.classOption} key={this.props.classOption}  onClick={this.props.classFunction}>
                {this.props.classOption}
            </button>
