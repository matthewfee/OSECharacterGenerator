...
class DetailsScreen extends React.Component {
    ...
    getName = () => {
        const firstNames = ["Balthazar", "Basil", "Bertram", "Blaxton", "Chadwick", "Clovis", "Jules", "Leopold", "Merrick", "Mortimer", "Ogden", "Orion", "Destrian", "Ellis", "Erasmus",  "Faustus", "Finn", "Fitzhugh", "Oswald", "Percival", "Quentin", "Redmaine", "Reinhold", "Florian", "Fox",  "Godwin", "Hannibal", "Jasper", "Jiles", "Silas", "Stilton", "Stratford", "Tenpiece", "Waverly", "Webster",
        "Adelaide", "Alma", "Barsaba", "Beatrix", "Bianca", "Cleopha", "Morgot", "Minerva", "Nerissa", "Odette",  "Olga", "Orchid", "Clover", "Constance", "Damaris", "Daphne",  "Demona",  "Elsbeth",  "Pepper", "Phoebe", "Piety", "Poppy", "Silence", "Sybil",  "Esme", "Fern", "Hester", "Hippolyta", "Jessamine", "Jilly", "Trillby",  "Tuesday", "Ursula",  "Vivian", "Wendy", "Zora"
        ]

        const lastNames = ["Belvedere", "Bithesea", "Calaver", "Carvolo", "De Rippe", "Drolle", "La Marque", "Malmora", "Miter", "Oblington", "Onymous", "Phillifent", "Dunlow", "Edevane", "Erelong", "Febland", "Fernsby", "Fisk", "Portendorfer", "Romatet", "Rothery", "Skorbeck", "Slora", "Southwark", "Gastrell", "Girdwood", "Gorgon", "Grimeson", "Gruger", "Hitheryon", "Stavish", "Vandermeer", "Wellbelove", "Westergren", "Wexley", "Wilberforce",
    
        "Barrow", "Beetleman", "Berrycloth", "Birdwhistle", "Bobich", "Chips", "Knibbs", "Midnighter", "Needle", "Nethercoat", "Pestle", "Relish", "Coffin", "Crumpling", "Culpepper", "Dankworth", "Digworthy", "Dreggs", "Rumbold", "Rummage", "Sallow", "Saltmarsh", "Silverless", "Skitter", "Gimble", "Graveworm", "Greelish", "Hardwick", "Hatman", "Hovel", "Slee", "Slitherly", "Stoker", "Tarwater", "Tumbler", "Villin"]
            ...
            <div className="character-details-form">
                ...
                <div className="form-label form-label--alignment">
                    ...
                    <button 
                        type="button"
                        value="lawful"
                        className={this.state.alignment === "lawful" ? "button button--alignment button--alignment--selected" : "button button--alignment"}
                    ...
                    <button 
                        type="button"
                        value="neutral"
                        className={this.state.alignment === "neutral" ? "button button--alignment button--alignment--selected" : "button button--alignment"}
                        onClick={(e) => this.handleAlignment(e, "value")}
                    ...
                    <button 
                        type="button"
                        value="chaotic"
                        className={this.state.alignment === "chaotic" ? "button button--alignment button--alignment--selected" : "button button--alignment"}
                        onClick={(e) => this.handleAlignment(e, "value")}
                    >
                        Chaotic
                ...
                <div className="form-label form-label--optional-details">
                    <div type="button" className="form-text">Optional Details</div>

                    {!this.state.appearance && <button 
                                                type="button" 
                    ...
                    {this.state.appearance && <div className="details-result">
                        
                        <span className="details-result--name"> Appearance:  </span>
                        <span className="details-result--data"> {this.state.appearance}</span>
    
                        </div>}
                        
                    {!this.state.personality && <button 
                                                type="button" 
                                                className="button button--optional-details" 
                    ...
                    {this.state.personality && <div className="details-result">
                        
                        <span className="details-result--name">Personality:</span>
                        <span className="details-result--data">{this.state.personality}</span>

                        </div>}

                    {!this.state.background && <button 
                                                type="button" 
                                                className="button button--optional-details" 
                    ...
                    {this.state.background && <div className="details-result">
