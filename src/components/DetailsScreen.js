...
import { firstNames, lastNames, appearances } from "../constants/constants";

export default function DetailsScreen(props) {
  const { pages, setPages, character, setCharacter, characterClass } = props;
  ...
  useEffect(() => {
    ...
    const languagesArr = characterClass.lanugages.split(",");
